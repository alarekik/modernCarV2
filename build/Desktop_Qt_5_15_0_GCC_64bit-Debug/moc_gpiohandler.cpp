...
QT_MOC_LITERAL(1, 12, 16), // "gpioValueChanged"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 8), // "readGpio"
QT_MOC_LITERAL(4, 39, 9) // "gpioValue"

    },
    "gpiohandler\0gpioValueChanged\0\0readGpio\0"
    "gpioValue"
};
...
void gpiohandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->gpioValueChanged(); break;
        case 1: _t->readGpio(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&gpiohandler::gpioValueChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< int*>(_v) = _t->gpioValue(); break;
        default: break;
        }
...
// SIGNAL 0
void gpiohandler::gpioValueChanged()
{
