...
QT_MOC_LITERAL(5, 46, 11) // "lastMessage"

    },
    "uarthandler\0dataReceived\0\0message\0"
    "onReadyRead\0lastMessage"
};
...
void uarthandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&uarthandler::dataReceived)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject uarthandler::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_uarthandler.data,
    qt_meta_data_uarthandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
